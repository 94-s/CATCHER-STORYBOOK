...
export const CounterPart = (args: ChatCardProps) => {
  return <ChatCard message="하윙" me={false} />;
};

export const CounterPartLongText = (args: ChatCardProps) => {
  return (
    <ChatCard
      message="하kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk윙"
      me={false}
    />
  );
};
...
export const Me = (args: ChatCardProps) => {
  return <ChatCard message="하윙" me={true} />;
};
...
export const Chatting = (args: ChatCardProps) => {
  return (
    <div>
      <ChatCard
        message="하kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk윙"
