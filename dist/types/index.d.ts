...
interface ButtonProps$1 extends React__default.HTMLAttributes<HTMLButtonElement> {
    /**
...
declare const MainButton: (props: ButtonProps$1) => JSX.Element;
...
declare const FormInput: React__default.ForwardRefExoticComponent<InputProps$1 & React__default.RefAttributes<HTMLInputElement>>;
...
declare const CommonButton: React__default.ForwardRefExoticComponent<ButtonProps & React__default.RefAttributes<HTMLButtonElement>>;
...
export { CatherItem, ChatInput, CheckBox as Checkbox, CommonButton, Container, Footer, FormInput, GlobalStyles, Header, Icon, InputText, Label, MainButton, Popup, Radio, Select, Textarea, Toggle };
